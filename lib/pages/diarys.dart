...
class Diarys extends StatelessWidget {
        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                DiariesController.to.foldDiary();
              },
              child: Icon(
              ...
              child: Padding(
                ...
                child: Obx(
                  () => GridView.builder(
                    ...
                    itemCount: DiariesController.to.isFold.value ? 3 : 5,
                    itemBuilder: (context, index) {
                      return DiariesController.to.isFold.value
                          ? _foldedDiary()
                          : _notFoldedDiary(index);
                    },
                  ),
                ),
              ),
  ...
  Widget _notFoldedDiary(int index) {
    if (index == 0) {
      return Container(
        padding: EdgeInsets.all(16.0.r),
        width: Get.width / 2 - 43.5.w,
