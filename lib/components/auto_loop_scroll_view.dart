...
class AutoLoopScrollView extends StatefulWidget {
  const AutoLoopScrollView({
    required this.child,
  ...
  @override
  State<AutoLoopScrollView> createState() => _AutoLoopScrollViewState();
}

class _AutoLoopScrollViewState extends State<AutoLoopScrollView>
